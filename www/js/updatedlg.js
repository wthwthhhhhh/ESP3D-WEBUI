...
function updatedlg() {
    ...
    if (target_firmware == "grbl-embedded") document.getElementById('fw_update_dlg_title').innerHTML = translate_text_item("CoolDraw Update").replace("CoolDraw", "GRBL_ESP32");
    if (target_firmware == "marlin-embedded") document.getElementById('fw_update_dlg_title').innerHTML = translate_text_item("CoolDraw Update").replace("CoolDraw", "Marlin");
    showModal();
}
